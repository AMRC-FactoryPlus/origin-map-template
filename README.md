...
- **Description**: Tag interaction method(s).
	...
	- For **Fieldbus**:`GET` for read-only outputs and static values and `PUT` for inputs or write operations.
- **Data type**: String
